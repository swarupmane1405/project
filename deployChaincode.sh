...
chaincodeInvoke() {
    ...
    #     --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
    #     -c '{"function": "createPerson","Args":["PERSON2", "Chinmay", "1991-10-12", "Satara", "555-1234"]}'
...
chaincodeQuery() {
    ...
    # Query Car by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryPerson","Args":["PERSON1"]}'
